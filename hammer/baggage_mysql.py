...
for i in a:
    print(f"insert into aux_baggage (carrier, departure_aircode, arrival_aircode, baggage_weight, foreign_currency, "
          f"foreign_price) values ('TR', '{i[0]}', '{i[1]}', '{i[2]}', '{i[3]}', '{i[4]}');")